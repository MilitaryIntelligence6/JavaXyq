...
public class MapConfigImpl implements IConfig {
    ...
    public MapConfigImpl(String id, String name, String path) {
        this.id = id;
        this.name = name;
        this.path = path;
    }

    public MapConfigImpl(String id, String name, String path, String music) {
        this(id, name, path);
        this.music = music;
    }
